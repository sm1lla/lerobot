...
def record_loop(
    ...
    (
        ...
        pick, place, norm_pick, norm_place, pick_labels, place_labels
    )
    ...
    while timestamp < control_time_s:
        ...
        if events["select_new_bbox"]:
            ...
            single_task = (
                f"Grasp {pick_target_label} and put it in {place_target_label}"
            )
        ...
        if display_data:
            for obs, val in observation.items():
                if isinstance(val, float):
                    ...
                    val = np.array(
                        plot_bbox(
                            observation["top"], pick_bbox=pick_t, place_bbox=place_t
                        )
                    )
